    ...
    return (
        <>
            ...
            <div className=" h-screen flex justify-center items-center " >
                ...
                <div className="rounded-md  border border-stroke shadow-default bg-white dark:border-strokedark dark:bg-boxdark  my-8">
                    <div className="flex flex-wrap  items-center justify-center">


                        <div className="w-full h-view border-stroke dark:border-strokedark">
                            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                                ...
                                <form onSubmit={handleSubmit(handleFormSubmit)}  >
                                    ...
                                    {errors?.cpf && <p className="text-meta-1">{errors?.cpf?.message}</p>}
